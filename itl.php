...
echo "testing: itl_h_date(20, 8, 2008)\n";
echo "output:\n";
...
echo "testing itl_get_prayer_times(39.8304, 21.4206, 3, 6, 21, 8, 2008)\n";
echo "output:\n";
print_r(itl_get_prayer_times(39.8304, 21.4206, 3, 6, 21, 8, 2008));
